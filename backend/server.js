...
app.post("/api/auth/send-otp", async (req, res) => {
  try {
    ...
    //   },
    //   to: [{ email: email }],
    //   subject: "Welcome to StockSagu - Your OTP Code",
    //   htmlContent: `
    //     <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 10px;">
    //       <h2 style="color: #2c3e50; text-align: center;">Stock Dashboard OTP Verification</h2>
    //       <p>Hello,</p>
    //       <p>Your One-Time Password (OTP) for accessing the Stock Dashboard is:</p>
    ...
    //     </div>
    //   `,
    //   textContent: `Your Stock Dashboard OTP is: ${otp}. This OTP is valid for 10 minutes.`
    // };
    const sendSmtpEmail = {
  sender: { 
